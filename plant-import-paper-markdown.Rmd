...
df = data.frame("freq" = c(30.30, 45.45, NA, 12.12, 12.12, NA, # start with plant frequencies
...
ggplot(aes(x=factor(group, 
  ...
  annotate(geom = "text", label="30.3 %", x=1, y=0.84, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="45.5 %", x=1, y=0.45, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="12.1 %", x=1, y=0.18, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="12.1 %", x=1, y=0.06, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="39.5%", x=2, y=0.8, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="0.8 %", x=2, y=0.6, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="22.3 %", x=2, y=0.5, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="22.9 %", x=2, y=0.26, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="10.9 %", x=2, y=0.1, size=4, color="black", fontface = 2) +
  annotate(geom = "text", label="3.6 %", x=2, y=0.02, size=4, color="black", fontface = 2) +
  scale_y_continuous(labels = scales::percent) # save as .pdf landscape 5 x 6

```


### metabarcoding vs. germination ### 

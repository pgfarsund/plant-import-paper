...
mod <- lm(Observed ~ interval * host, data = obs.df); anova(mod)
...
# p46 remains alone without its partner, and needes to be removed: 
...
library(ggplotify)
fsac <- as.ggplot(fsac); psac # pdf landscape 5 x 5

ggarrange(psac, fsac, nrow = 1) # 5 x 10
```
